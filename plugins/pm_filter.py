...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/+_X48DP2opzE0MDY1'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/+_X48DP2opzE0MDY1')
            ],[      
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://t.me/dark_webos')
            ],[
